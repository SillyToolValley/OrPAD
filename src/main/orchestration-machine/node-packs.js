...
const STARTER_NODE_PACK_MANIFESTS = [
  ...
  },
  {
    ...
    authoringHints: {
      ...
      selectionReason: 'The request or workspace touches browser-facing UI behavior, graph editor interaction, context menus, inspector controls, CSS, visual reference styling, theme/palette work, or e2e UX verification.',
      context: {
        id: 'map-frontend-ux-surface',
        label: 'Map frontend UX surface',
        summary: 'Collect renderer, web UI, style, interaction-state, graph editor, e2e, and any requested reference-image palette or surface evidence before proposing UI changes.',
      },
      probe: {
      ...
      candidateTargetPolicy: [
        ...
        'Reference-image findings should target the palette/theme source, CSS surface system, and representative markup/component files when the requested reference is a hero, layout, composition, or surface hierarchy. Keep reference images, generated screenshots, and existing visual smoke coverage as source evidence/read-only context unless the user explicitly requests harness edits.',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        path: 'nodes/pull-request.or-node',
        runtimeHandlerKind: 'machine-builtin',
        machineApi: 'orpad.machine.v1',
        capabilities: ['read.workspace', 'write.workspace', 'write.runArtifacts'],
      },
