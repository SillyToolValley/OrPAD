export default {
  id: 'node-pack-submission',
  label: 'Node Pack Submission',
  description: 'Review record for a community or internal node-pack package before registry approval.',
  filename: (vars) => `node-pack-submission-${vars.slug(vars.title)}.md`,
  fields: [
  ...
  body: (vars) => `# Node Pack Submission: ${vars.title}
