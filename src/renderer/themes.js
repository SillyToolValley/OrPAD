...
export const builtinThemes = {
  'orpad-hero': {
    name: 'OrPAD Default', type: 'light',
    colors: {
      bgPrimary: '#f6f8fd', bgSecondary: '#ffffff', borderColor: '#d7e0ef',
      textPrimary: '#17233d', textSecondary: '#56677f', textTertiary: '#8794aa',
      accentColor: '#236cff', linkColor: '#007dff',
      hoverBg: 'rgba(35,108,255,0.08)', activeBg: 'rgba(35,108,255,0.14)',
      codeBg: 'rgba(35,108,255,0.08)', preBg: '#edf4ff',
      graphNodeBg: '#ffffff', graphNodeBgActive: '#edf5ff', graphNodeBorder: '#b9c9e4',
      graphNodeText: '#17233d', graphNodeMuted: '#5c6f8b', graphNodeShadow: 'rgba(35,73,132,0.16)',
      tableBorder: '#d7e0ef', tableHeaderBg: '#edf4ff', tableRowBg: 'rgba(35,108,255,0.045)',
      scrollbarThumb: 'rgba(35,108,255,0.18)', scrollbarThumbHover: 'rgba(35,108,255,0.34)',
      editorBg: '#fbfdff', editorGutterBg: '#edf4ff', editorGutterColor: '#7a8cab',
      editorActiveLine: '#f0f6ff', editorSelection: 'rgba(35,108,255,0.22)', editorCursor: '#236cff',
      syntaxComment: '#728198', syntaxKeyword: '#2559d8', syntaxString: '#128f9b',
      syntaxNumber: '#7a56d6', syntaxFunction: '#007dff', syntaxVariable: '#17233d',
      syntaxTag: '#d92f54', syntaxAttribute: '#006ddf', syntaxOperator: '#0f68c8',
      syntaxMeta: '#d98b1e', syntaxAdded: '#19a886', syntaxDeleted: '#d92f54',
      syntaxAddedBg: 'rgba(25,168,134,0.12)', syntaxDeletedBg: 'rgba(217,47,84,0.11)',
    },
  },
  'github-light': {
